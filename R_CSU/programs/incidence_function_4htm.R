...
# Save the dataset
write.csv(incidence_results, file.path(TABLES, paste0("CSU_incifunc_4htm_", verCalib, "calib_", estMethod, "_", imputationModelChoice, ifelse(imputationWeighted == 1, "wt", "uwt"), ".csv")), row.names = FALSE)
...
# Save the dataset
write.csv(incidence_results_norm, file.path(TABLES, paste0("CSU_incifunc_4htm_", verCalib, "calib_", estMethod, "_", imputationModelChoice, ifelse(imputationWeighted == 1, "wt", "uwt"), "_norm.csv")), row.names = FALSE)
#incidence_results_norm <- read.csv(file.path(TABLES,(paste0("CSU_incifunc_", 4, "htm_", verCalib, "calib_", estMethod, "_", imputationModelChoice, ifelse(imputationWeighted == 1, "wt", "uwt"), "_norm.csv"))))
...
# Save plot
ggsave(paste0("incidence_plot_4htm_", verCalib, "calib_", estMethod, "_", imputationModelChoice, ifelse(imputationWeighted == 1, "wt", "uwt"), "_norm.png"), plot = incidence_plot, path = file.path(OUTPUT, "graphs"), bg = "white", width = 7, height = 7)