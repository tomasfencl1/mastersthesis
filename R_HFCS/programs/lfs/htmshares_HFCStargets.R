...
# desc: calculates p/w/n-HtM (and top10) shares for targets in LFS imputation
################################################################################
...
################################################################################
# Save to CSV
write.csv(s_all, file.path(OUTPUT, paste0("lfs/",DBNAME,"_HtM_shares.csv")), row.names = FALSE)
write.csv(s_htm, file.path(OUTPUT, paste0("lfs/",DBNAME,"_HtM_nHtM_shares.csv")), row.names = FALSE)
write.csv(s_phtm, file.path(OUTPUT, paste0("lfs/",DBNAME,"_pHtM_wHtM_shares.csv")), row.names = FALSE)
if (top10Index == 1) {
  write.csv(s_t10nhtm, file.path(OUTPUT, paste0("lfs/",DBNAME,"_nHtM_top10_shares.csv")), row.names = FALSE)
}
write.csv(s_inc_all, file.path(OUTPUT, paste0("lfs/",DBNAME,"_HtM_inc_shares.csv")), row.names = FALSE)
